  ...
  return (
    <main className="debug-page">
      ...
      <header className="debug-header">
        <p className="eyebrow">Diagnostics / Tray camera</p>
      ...
      <section className="debug-grid">
        <div className="debug-viewport">
          <svg viewBox="0 0 1000 750" preserveAspectRatio="xMidYMid meet">
          ...
          {!frame && <p className="debug-empty">Start `task vision:dev` to receive detections.</p>}
        </div>

        <aside className="debug-data">
          <section>
            <div className="section-heading"><span>01</span><h2>Hands</h2></div>
          ...
          <section>
            <div className="section-heading"><span>03</span><h2>Last event</h2></div>
            <dl>
